    ...
    return (<main style={{ background: "#f4f6f8", color: "#0e1b2c", overflowX: "hidden" }}>
      ...
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 clamp(20px,4vw,56px)", height: 72, position: "sticky", top: 0, zIndex: 50, background: "rgba(244,246,248,0.92)", backdropFilter: "blur(10px)", borderBottom: "1px solid rgba(14,27,44,0.1)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.15 }}>
            <span style={{ fontWeight: 900, fontSize: "1rem", letterSpacing: "0.02em" }}>TSUKURU</span>
            <span style={{ fontSize: "0.68rem", fontWeight: 500, letterSpacing: "0.22em", color: "#5a6b80" }}>WEB DESIGN STUDIO</span>
          </div>
        </div>
        <nav style={{ display: "flex", alignItems: "center", gap: 32 }}>
          <a href="#strength" style={{ fontWeight: 700, fontSize: "0.88rem" }}>強み</a>
          <a href="#works" style={{ fontWeight: 700, fontSize: "0.88rem" }}>実績</a>
          <a href="#price" style={{ fontWeight: 700, fontSize: "0.88rem" }}>料金</a>
          <a href="#flow" style={{ fontWeight: 700, fontSize: "0.88rem" }}>流れ</a>
          <a href="#faq" style={{ fontWeight: 700, fontSize: "0.88rem" }}>FAQ</a>
          <a href="#contact" style={{ background: "#2f6bff", color: "#fff", fontWeight: 700, fontSize: "0.88rem", padding: "12px 28px" }}>無料相談 →</a>
        </nav>
      </header>
      ...
      <section style={{ position: "relative", padding: "clamp(70px,11vh,130px) clamp(20px,4vw,56px) 0" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1240, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 16, marginTop: 44, flexWrap: "wrap" }}>
            <a href="#contact" style={{ background: "#0e1b2c", color: "#fff", fontWeight: 700, fontSize: "1.05rem", padding: "18px 48px", display: "inline-flex", alignItems: "center", gap: 12 }}>無料で相談する<span>→</span></a>
            <a href="#works" style={{ background: "transparent", color: "#0e1b2c", fontWeight: 700, fontSize: "1.05rem", padding: "18px 40px", border: "1.5px solid #0e1b2c" }}>制作実績を見る</a>
          </div>
      ...
      <section id="strength" style={{ padding: "clamp(70px,11vh,130px) clamp(20px,4vw,56px)", background: "#fff", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "relative", maxWidth: 1240, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 56, padding: "32px 36px", border: "1.5px solid #0e1b2c", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 20 }}>
            ...
            <a href="#compare" style={{ background: "#0e1b2c", color: "#fff", fontWeight: 700, fontSize: "0.95rem", padding: "16px 36px", display: "inline-flex", alignItems: "center", gap: 10 }}>制作会社との比較を見る<span>→</span></a>
          </div>
        </div>
      </section>
        ...
        <div style={{ position: "relative", maxWidth: 1240, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0,1fr))", gap: "clamp(20px,2.5vw,32px)", alignItems: "start" }}>
            <div style={{ border: "1.5px solid #0e1b2c", padding: "40px 32px", display: "flex", flexDirection: "column", gap: 18, marginTop: 48 }}>
              ...
              <a href="#contact" style={{ border: "1.5px solid #0e1b2c", color: "#0e1b2c", fontWeight: 700, fontSize: "0.95rem", padding: "14px 0", textAlign: "center" }}>相談する →</a>
            </div>
            <div style={{ background: "#0e1b2c", color: "#fff", padding: "40px 32px", display: "flex", flexDirection: "column", gap: 18, position: "relative" }}>
              ...
              <a href="#contact" style={{ background: "#2f6bff", color: "#fff", fontWeight: 700, fontSize: "0.95rem", padding: "14px 0", textAlign: "center" }}>相談する →</a>
            </div>
            <div style={{ border: "1.5px solid #0e1b2c", padding: "40px 32px", display: "flex", flexDirection: "column", gap: 18, marginTop: 48 }}>
      ...
      <section id="contact" style={{ background: "#0e1b2c", color: "#fff", padding: "clamp(80px,12vh,150px) clamp(20px,4vw,56px)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1240, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <a href="mailto:hello@tsukuru-web.example" style={{ background: "#2f6bff", color: "#fff", fontWeight: 700, fontSize: "1.1rem", padding: "20px 56px", display: "inline-flex", alignItems: "center", gap: 12 }}>無料相談・お見積り<span>→</span></a>
            <a href="#price" style={{ border: "1.5px solid rgba(255,255,255,0.5)", color: "#fff", fontWeight: 700, fontSize: "1.1rem", padding: "20px 44px" }}>料金を見る</a>
          </div>
        </div>
      </section>
      ...
      <footer style={{ background: "#0e1b2c", color: "#fff", padding: "32px clamp(20px,4vw,56px)", borderTop: "1px solid rgba(255,255,255,0.14)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span style={{ fontWeight: 900, letterSpacing: "0.02em" }}>TSUKURU WEB STUDIO</span>
        </div>
