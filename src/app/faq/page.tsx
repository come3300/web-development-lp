...
export const metadata: Metadata = {
  title: "よくあるご質問｜WEBKURA",
  description: "料金・制作・契約や運用について、WEBKURAへよくいただくご質問と回答をカテゴリ別にまとめました。",
};
...
const CATEGORIES: { name: string; items: [string, string][] }[] = [
  {
    name: "料金について",
    items: [
      ["相談や見積りに費用はかかりますか。", "いずれも無料です。「まだ何も決まっていない」段階でも問題ありません。ぜひお気軽にご相談ください"],
      ["見積り後に追加費用が発生することはありますか。", "工程開始後に大きな仕様変更がない限り、追加費用は発生しません。追加が必要な場合も事前に金額をご提示し、ご了承の上で進めさせていただきます。"],
  ...
  },
  {
    name: "制作について",
    items: [
      ["Webの知識がなくても依頼できますか。", "はい。ヒアリングの上、必要なものはこちらからご提案します。"],
  ...
  },
  {
    name: "契約・運用について",
    items: [
      ["自分たちで更新できるようにしたいのですが。", "CMS(更新システム)を導入し、操作レクチャーまでご案内いたします。"],
  ...
  },
  {
    name: "SEO・その他について",
    items: [
      ["SEO対策はしてもらえますか。", "基本的なSEO設定は全プランに含まれます。より本格的な対策は別途ご相談ください。"],
